...
export declare const handleArg: (doc: Document, el: HElement, arg: ElArg) => Node | undefined;
export declare const handleChildArg: (doc: Document, el: Node, arg: ElArg, next?: () => void) => Node | undefined;
